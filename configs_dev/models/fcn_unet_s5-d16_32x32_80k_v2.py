...
# data_root = 'Wheat/data/Spikelet_small_v2'
# model settings
device = 'cuda'
...
model = dict(
    ...
    decode_head=dict(
        ...
        align_corners=False,
        loss_decode=dict(
            type='CrossEntropyLoss', use_sigmoid=False, loss_weight=1.0, class_weight=[0.557, 4.87])),  # added mfb class_weight
    auxiliary_head=dict(
        type='FCNHead',
        in_channels=32,
        in_index=3,
        ...
        align_corners=False,
        loss_decode=dict(
            type='CrossEntropyLoss', use_sigmoid=False, loss_weight=0.4, class_weight=[0.557, 4.87])),  # added mfb class_weight
...
# resume_from = work_dir + 'iter_79000.pth'
log_config = dict(
    interval=1,
    hooks=[
        ...
        dict(
            ...
            init_kwargs={'entity': 'unholytsar',
                         ...
                         'name': 'fcn_unet_s5_d16_80k_v2_b1',
                         'dir': work_dir,
                         'resume': 'allow',
                         'id': '2ksi3syairsdfg'},
            interval=1)])
