...
model = dict(
    ...
    decode_head=dict(
        ...
        align_corners=False,
        loss_decode=dict(
            type='CrossEntropyLoss', use_sigmoid=False, loss_weight=1.0, class_weight=[0.51, 21.32])),  # added mfb class_weight # 21.32 = normalized, 24.4 = not
    auxiliary_head=dict(
        type='FCNHead',
        ...
        align_corners=False,
        loss_decode=dict(
            type='CrossEntropyLoss', use_sigmoid=False, loss_weight=0.4, class_weight=[0.51, 21.32])),  # added mfb class_weight
    #auxiliary_head=None,
    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs={'entity': 'unholytsar',
                         ...
                         'name': 'fcn_unet_s5_d16_80k_v3_b2_n',
                         'dir': work_dir,
                         'resume': 'allow',
                         'id': '2ksi3syaiderty'},
            interval=1)])
